...
urlpatterns = [
  url(r'^(?P<id>[0-9]+)/purchase/(?P<purchase_id>[0-9]+)', views.MemberPurchaseView.member_purchase_element, name='member_purchase_element'),
  url(r'^(?P<id>[0-9]+)/purchase', views.MemberPurchaseView.member_purchase_collection, name='member_purchase_collection'),
