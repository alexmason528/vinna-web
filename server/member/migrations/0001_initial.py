    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mailing_address_country', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.Country')),
                ('mailing_address_state', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.State')),
